...
@implementation LibreCreateForumViewController {
...
- (void)create {
    ...
    LibreForum* instance = [LibreForum alloc];
...
- (void) response: (LibreForum*) response {
    [self stopBusy];
    
    //LibreForumViewController *view = [[LibreForumViewController alloc] init];
