...
public class AvatarConfig extends WebMediumConfig {
	...
	public ChatResponse chatReply(ChatResponse chat) {
		...
		if (action != null) {
			...
			if (!matching.isEmpty()) {
				...
				String[] array = media.media.split("\\.");
				chat.avatarAction = media.mediaId+"."+array[1];
			}
		}
...
//	public String getDefaultAvatarMediaOne(){
//		String name = null;
//		for (AvatarMedia media: mediaConfig.values()) {
//			if(!media.talking && media.hd && media.name.contains("blink") && media.poses.equals("") && media.emotions.equals("")){
//				String[] array = media.media.split("\\.");
//				name = media.mediaId+"."+array[1];
//				type = media.type;
//			}
//		}
//		return name;
//	}
//	public String getDefaultAvatarMediaTwo(){
//		String name = null;
//		for (AvatarMedia media: mediaConfig.values()) {
//			if(!media.talking && media.hd && media.name.contains("blink") && media.emotions.contains("HAPPY")){
//				String[] array = media.media.split("\\.");
//				name = media.mediaId+"."+array[1];
//				type = media.type;
//			}
...
//	}
//	
//	public String getDefaultAvatarMediaThree(){
//		String name = null;
//		for (AvatarMedia media: mediaConfig.values()) {
//			if(!media.talking && media.hd && media.name.contains("blink") && media.emotions.contains("ANGER")){
//				String[] array = media.media.split("\\.");
//				name = media.mediaId+"."+array[1];
//				type = media.type;
//			}
...
//		return name;
//	}
//	public String getDefaultAvatarMediaFour(){
//		String name = null;
//		for (AvatarMedia media: mediaConfig.values()) {
//			if(!media.talking && media.hd && media.name.contains("blink") && media.emotions.equals("") && media.poses.contains("sleeping")){
//				String[] array = media.media.split("\\.");
//				name = media.mediaId+"."+array[1];
//				type = media.type;
//			}
...
//		return name;
//	}
//	public String getTalkingAvatarMedia(){
//		String name = null;
//		for(AvatarMedia media : mediaConfig.values()){
//			if(media.talking && media.hd && media.name.contains("talk")){
//				String[] array = media.media.split("\\.");
//				name = media.mediaId +"."+ array[1];
//				type = media.type;
//			}
...
//	}
//	
//	public String getTypeAvatarMedia(){
//		return type;
//	}
