...
public class HttpGetResponsesAction extends HttpUIAction {

	ResponseSearchConfig config;
	List<ResponseConfig> responses;
	
	public HttpGetResponsesAction(Activity activity, ResponseSearchConfig config) {
		super(activity);
		this.config = config;
	}
	...
	protected String doInBackground(Void... params) {
		try {
		this.responses = MainActivity.connection.getResponses(this.config);
	...
	public void onPostExecute(String xml) {
		...
		try {
			((TrainingActivity)this.activity).setResponses(this.responses);
