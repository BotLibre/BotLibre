...
public class HttpImportBotLogAction extends HttpUIAction {
	ScriptConfig config;
	ScriptSourceConfig script;
	
	public HttpImportBotLogAction(Activity activity, ScriptConfig config) {
		super(activity);
		this.config = config;
	}
	...
	protected String doInBackground(Void... params) {
		try {
			...
			MainActivity.connection.importBotLog(this.config);
