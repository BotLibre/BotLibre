...
public class HttpGetScriptSourceAction extends HttpUIAction {
	ScriptConfig config;
	ScriptSourceConfig script;
	
	public HttpGetScriptSourceAction(Activity activity, ScriptConfig config) {
		super(activity);
		this.config = config;
	}
	...
	public void onPostExecute(String xml) {
		...
		try {
			MainActivity.script = this.script;
			
			((ScriptEditorActivity)this.activity).resetView();
