...
state Loop {
	...
	function checkLoop() {
		...
		random ("Nous semblons être dans une boucle, peut-être essayer de dire quelque chose de nouveau.", "Nous semblons répéter les mêmes phrases, essayez peut-être de dire quelque chose de différent.");
	}
}
