 ...
 */
@Entity
public class ForumAttachment extends AbstractMedia {
	...
	public MediaConfig toConfig() {
		...
		if (this.forum != null) {
			config.instance = String.valueOf(this.forum.getId());
		}
	...
	public String getFileName() {
		return "forum?attachment=" + this.mediaId + "&key=" + this.key +"&name=" + ForumBean.encode(this.name);
	}
}
