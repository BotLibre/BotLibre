...
import org.botlibre.web.bean.GoogleBean;
import org.botlibre.web.bean.LoginBean;
import org.botlibre.web.service.PageStats;

@javax.servlet.annotation.WebServlet("/google")
@SuppressWarnings("serial")
public class GoogleServlet extends BeanServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String authCode = Utils.sanitize((String)request.getParameter("authCode"));
			String authoriseComplete = (String)request.getParameter("authorise-complete");
			if (authoriseComplete != null) {
				bean.connect(authCode);
			}
			String cancel = (String)request.getParameter("cancel");
			if (cancel != null) {
				bean.setAuthorising(false);
			}
			String authorize = (String)request.getParameter("authorize");
			if (authorize != null) {
				bean.setAuthorising(true);
			}
