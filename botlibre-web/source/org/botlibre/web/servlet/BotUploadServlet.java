...
@javax.servlet.annotation.WebServlet("/bot-icon-upload")
@SuppressWarnings("serial")
@MultipartConfig
public class BotUploadServlet extends BeanServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("browse?id=" + bean.getInstanceId() + proxy.proxyString());
	}
}
