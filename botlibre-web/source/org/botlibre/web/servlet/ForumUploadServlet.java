...
@javax.servlet.annotation.WebServlet("/forum-icon-upload")
@SuppressWarnings("serial")
@MultipartConfig
public class ForumUploadServlet extends BeanServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("forum?details=true" + proxy.proxyString());
	}
}
