...
@javax.servlet.annotation.WebServlet("/log")
@SuppressWarnings("serial")
public class LogServlet extends BeanServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String clearWarnings = (String)request.getParameter("clearWarnings");
		...
		try {
			...
			if (clear != null) {
				botBean.clearLog();
			} else if (clearWarnings != null) {
				botBean.clearWarnings();
			} else {
				botBean.setLogLevel(level);
			}
