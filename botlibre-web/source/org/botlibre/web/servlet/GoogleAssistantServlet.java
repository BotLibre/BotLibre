...
import org.botlibre.web.bean.GoogleAssistantBean;
import org.botlibre.web.bean.LoginBean;
import org.botlibre.web.service.PageStats;

@javax.servlet.annotation.WebServlet("/google-assistant")
@SuppressWarnings("serial")
public class GoogleAssistantServlet extends BeanServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (!botBean.isConnected()) {
				response.sendRedirect("google-assistant.jsp");
				return;
			}
			botBean.checkAdmin();
