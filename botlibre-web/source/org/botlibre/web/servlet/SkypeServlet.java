...
import org.botlibre.web.bean.SkypeBean;
import org.botlibre.web.service.PageStats;

@javax.servlet.annotation.WebServlet("/skype")
@SuppressWarnings("serial")
public class SkypeServlet extends BeanServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (!botBean.isConnected()) {
				response.sendRedirect("skype.jsp");
				return;
			}
			botBean.checkAdmin();	
			...
			if (submit != null) {
				bean.save(/*token,*/ appId, appPassword);
				bean.connect();
			}
