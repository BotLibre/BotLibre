...
/**
 * Stores bot file/image attachments.
 */
@Entity
public class BotAttachment extends AbstractMedia {
	...
	public MediaConfig toConfig() {
		...
		if (this.bot != null) {
			config.instance = String.valueOf(this.bot.getId());
		}
	...
	public String getFileName() {
		return "bot?attachment=" + this.mediaId + "&key=" + this.key +"&name=" + LiveChatBean.encode(this.name);
	}
}
