...
<head>
	...
	<meta name="description" content="<%= loginBean.translate("Add and remove users and administrators for the script") %>"/>	
	<meta name="keywords" content="<%= loginBean.translate("users, administrators, access, security, script, file") %>"/>
		...
		<div class="clearfix">
			<span class="dropt-banner">
				<img id="help-mini" src="images/help.svg"/>
					<div>
						<%= loginBean.translate("The users tab allows you to add users, and administrators to your script.") %><br/>
					</div>
...
<% } %>
	<h1>
		<span class="dropt-banner">
			...
			<div>
				<p class="help">
					<%= loginBean.translate("Configure the users and administrators of your script.") %><br/>
				</p>
			</div>
