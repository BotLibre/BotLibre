...
function Connect4() {
	...
	this.moveSquare = function(cordinate) {
		this.listener.sendMessage(cordinate.toString());
	}
	...
	this.drawBoard = function(newBoard) {
		...
		var div = web.baseRoot.getElementById(this.listener.prefix + "avatar-game-div");
		var html = "<table id='checkers'><tr>";
		var div = web.baseRoot.getElementById(this.listener.prefix + "avatar-game-div");
		var html = "<table id='checkers'><tr>";
		for (var count = 0; count < 42; count++) {
			...
			if (count == 6 || count == 13 || count == 20 || count == 27 || count == 34) {
				html = html + "</tr><tr>";
			}
		}
		html = html + "</tr></table>";
	...
	this.updateAvatar = function(responseMessage) {
		...
		this.drawBoard(command.board);
		var div = web.baseRoot.getElementById(this.listener.prefix + "avatar-video-div");
		if (div != null) {
			div.style.display = "none";
		}
		div = web.baseRoot.getElementById(this.listener.prefix + "avatar-canvas-div");
		if (div != null) {
			div.style.display = "none";
		}
		div = web.baseRoot.getElementById(this.listener.prefix + "avatar-image-div");
		if (div != null) {
			div.style.display = "none";
		}
		var div = web.baseRoot.getElementById(this.listener.prefix + "avatar-game-div");
