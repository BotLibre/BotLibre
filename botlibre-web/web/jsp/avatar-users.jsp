...
<head>
	...
	<meta name="description" content="Add and remove users and administrators for the avatar"/>	
	<meta name="keywords" content="users, administrators, access, security, avatar"/>
	...
	<div id="admin-topper" align="left">
		<div class="clearfix">
			<span class="dropt-banner">
				...
				<div>
					<%= loginBean.translate("The users tab allows you to add users, and administrators to your avatar.") %><br/>
				</div>
...
<% } %>
	<h1>
		<span class="dropt-banner">
			...
			<div>
				<p class="help">
					<%= loginBean.translate("Configure the users and administrators of your avatar.") %><br/>
				</p>
			</div>
