		...
		<div id="contents">
			<div class="browse">
				...
				<% if (botBean.getInstance() == null || !botBean.getInstance().isExternal()) { %>
					...
					<a href="whatsapp.jsp"><img src="images/whatsapp7.png" class="admin-pic"></a> <a href="whatsapp.jsp"><%= loginBean.translate("WhatsApp") %></a> - <span><%= loginBean.translate("Allow your bot to send, receive, and reply to WhatsApp messages.") %></span><br/>
