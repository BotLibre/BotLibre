...
<head>
	...
	<meta name="description" content="Add and remove users and administrators for the issue tracker"/>	
	<meta name="keywords" content="users, administrators, access, security, issue tracking"/>
	...
	<div id="admin-topper" align="left">
		<div class="clearfix">
			<span class="dropt-banner">
				...
				<div>
					<%= loginBean.translate("The users tab allows you to add users, and administrators to your issue tracker.") %><br/>
				</div>
...
<% } %>
	<h1>
		<span class="dropt-banner">
			...
			<div>
				<p class="help">
					<%= loginBean.translate("Configure the users and administrators of your issue tracker.") %><br/>
				</p>
			</div>
