...
//import org.botlibre.sdk.activity.script.ScriptEditorActivity;
...
//
//public class HttpGetBotScriptSourceAction extends HttpUIAction {
//	ScriptSourceConfig config;
//	
//	public HttpGetBotScriptSourceAction(Activity activity, ScriptSourceConfig config) {
//		super(activity);
//		this.config = config;
//	}
//	
...
//		try {
//			this.config = MainActivity.connection.getBotScriptSource(this.config);
...
//			
//			((BotScriptEditorActivity)this.activity).resetView();
//			
