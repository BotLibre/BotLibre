...
public class ConversationListAdapter extends ArrayAdapter<Object> {
	...
	public ConversationListAdapter(Activity activity, String resourceId, List items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (config instanceof InputConfig) {
            ...
            holder.speakerView.setTypeface(null, Typeface.NORMAL,0);
            ...
            holder.speakerView.setTypeface(null, Typeface.BOLD,0);
