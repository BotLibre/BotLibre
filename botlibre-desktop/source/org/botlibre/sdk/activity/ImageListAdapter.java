...
public class ImageListAdapter extends ArrayAdapter<WebMediumConfig> {
    ...
    public ImageListAdapter(Activity activity, String resourceId, List<WebMediumConfig> items) {
        super(activity, resourceId, items);
        this.activity = activity;
    }
 
    public ImageListAdapter(ListTemplateView activity2, String imageList, Object[] allTemplates) {
    	super(activity2, imageList, allTemplates);
        this.activity = activity2;
	}

	public ImageListAdapter(ListTemplateView activity2, String imageList, List<InstanceConfig> allTemplates) {
