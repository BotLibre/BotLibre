...
//	private SharedPreferences cookies = MainActivity.current.getPreferences(Context.MODE_PRIVATE);
...
//		String lastT= cookies.getString("contentRating", null);
		config.type = getType();
		config.typeFilter = "Personal";
//		config.contentRating = lastT;
