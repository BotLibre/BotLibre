...
public class ForumPostImageListAdapter extends ArrayAdapter<ForumPostConfig> {
    ...
    public ForumPostImageListAdapter(Activity activity, String resourceId, List<ForumPostConfig> items) {
        super(activity, resourceId, items);
        this.activity = activity;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.creatorView.setText("by " + config.creator + ", " + config.displayCreationDate());
